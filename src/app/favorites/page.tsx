  ...
  useEffect(() => {
    const loadFavoriteProperties = async () => {
      try {
        ...
        const favoriteProps = mockProperties.filter((property) => favorites.includes(property.id));
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center max-w-md mx-auto">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">찜한 매물이 없습니다</h2>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-lg p-8 border">
            ...
            <p className="text-gray-600 mb-6">다양한 조건으로 원하는 매물을 찾아보실 수 있습니다.</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button asChild size="lg">
                <Link href="/properties">매물 목록 보기</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link href="/map">지도에서 검색</Link>
              </Button>
            </div>
          </div>
        </div>
